...
namespace PhapClinicX.Areas.Admin.Controllers
{
    ...
    public class ServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ServiceId,ServiceName,Price,IsActive,Image,Detail")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServiceId,ServiceName,Price,IsActive,Image,Detail")] Service service)
        {
