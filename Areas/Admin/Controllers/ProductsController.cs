...
namespace PhapClinicX.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(ClinicManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,CategoryId,ProductName,Price,Image,Description,Detail,Warranty,IsActive,PriceSale,ProductSold,ProductImport,Alias,CreatedDate,IsNew,IsBestSeller,Star")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,CategoryId,ProductName,Price,Image,Description,Detail,Warranty,IsActive,PriceSale,ProductSold,ProductImport,Alias,CreatedDate,IsNew,IsBestSeller,Star")] Product product)
        {
