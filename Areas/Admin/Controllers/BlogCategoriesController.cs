...
namespace PhapClinicX.Areas.Admin.Controllers
{
    ...
    public class BlogCategoriesController : Controller
    {
        ...
        public BlogCategoriesController(ClinicManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CategoryId,CategoryName,IsActive,Alias")] BlogCategory blogCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId,CategoryName,IsActive,Alias")] BlogCategory blogCategory)
        {
