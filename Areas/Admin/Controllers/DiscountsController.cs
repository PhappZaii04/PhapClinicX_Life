...
namespace PhapClinicX.Areas.Admin.Controllers
{
    ...
    public class DiscountsController : Controller
    {
        ...
        public DiscountsController(ClinicManagementContext context)
        {
            _context = context;
        }
        [HttpPost]
        public async Task<IActionResult> UploadImage(IFormFile file)
        {
            ...
            string uploadsFolder = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/assets/img/voucher");
        ...
        public async Task<IActionResult> Create([Bind("DiscountId,DiscountName,DiscountPercent,Image,StartDate,EndDate,IsActive")] Discount discount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DiscountId,DiscountName,DiscountPercent,Image,StartDate,EndDate,IsActive")] Discount discount)
        {
