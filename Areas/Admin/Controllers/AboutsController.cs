...
namespace PhapClinicX.Areas.Admin.Controllers
{
    ...
    public class AboutsController : Controller
    {
        ...
        public AboutsController(ClinicManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AboutId,Title,Content,Image,CreatedAt,IsActive")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AboutId,Title,Content,Image,CreatedAt,IsActive")] About about)
        {
            if (id != about.AboutId)
            {
                return NotFound();
